...
export interface Product {
  ...
  sellType?: SellType
  /** Цена указана за столько грамм (1000 = за 1 кг) — только для sellType=weight */
  unitGrams?: number
  /**
   * Вес одной штуки/упаковки в граммах — для доставки (особенно при «размер»).
   * Не путать с unitGrams (цена за N г у развеса).
   */
