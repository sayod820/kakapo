...
export const DEMO_COURIER_ORDERS: DemoCourierOrder[] = [
  ...
  { id: 'K-4838', mapStatus: 'ready', pickupIds: ['rest2', 'store'], client: 'Зафар Мирзоев', phone: '+992 88 789-01-23', addr: 'ул. Рудаки, 8', lat: 38.3300, lng: 69.0180, weight: 1.2, pay: 'Наличными', time: '13:58', sum: 70.00, items: [{ e: '🍕', n: 'Пепперони', q: 1, p: 32.0 }, { e: '🍕', n: 'Маргарита', q: 1, p: 28.0 }, { e: '🥤', n: 'Сок', q: 2, p: 5.0 }] },
  ...
  { id: 'K-4841', mapStatus: 'ready', pickupIds: ['rest4', 'store'], client: 'Гулнора Садиева', phone: '+992 90 888-44-21', addr: 'мкр. Садовый, 7', lat: 38.3380, lng: 69.0240, weight: 0.9, pay: 'Наличными', time: '13:40', sum: 34.00, items: [{ e: '🍔', n: 'Бургер', q: 1, p: 16.0 }, { e: '🌭', n: 'Хот-дог', q: 1, p: 8.0 }, { e: '🥤', n: 'Напиток', q: 2, p: 5.0 }] },
  { id: 'K-4843', mapStatus: 'ready', pickupIds: ['rest1', 'rest2', 'store'], client: 'Нозим Тошматов', phone: '+992 92 777-11-22', addr: 'ул. Навои, 14', lat: 38.3190, lng: 69.0260, weight: 2.4, pay: 'Картой', time: '13:30', sum: 112.00, items: [{ e: '🍖', n: 'Плов большой', q: 1, p: 28.0 }, { e: '🍕', n: 'Пицца', q: 1, p: 32.0 }, { e: '🥛', n: 'Молоко', q: 2, p: 4.9 }, { e: '🧃', n: 'Сок', q: 3, p: 14.0 }] },
  { id: 'K-4845', mapStatus: 'waiting', pickupIds: [], client: 'Дилovar Р.', phone: '+992 93 456-78-90', addr: 'ул. Ленина, 42', lat: 38.3280, lng: 69.0310, weight: 1.5, pay: 'Наличными', time: '14:30', sum: 42.00, items: [{ e: '🍚', n: 'Плов', q: 2, p: 18.0 }] },
  { id: 'K-4846', mapStatus: 'waiting', pickupIds: [], client: 'Сабина К.', phone: '+992 90 111-22-33', addr: 'ул. Сомони, 5', lat: 38.3220, lng: 69.0190, weight: 3.2, pay: 'Наличными', time: '14:28', sum: 28.50, items: [{ e: '🥦', n: 'Брокколи', q: 1, p: 5.5 }, { e: '🥩', n: 'Говядина', q: 1, p: 38.0 }] },
];
