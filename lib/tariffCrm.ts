...
export const TARIFF_FIELD_META: {
  ...
  { key: 'weightStepKg', label: 'Шаг веса', unit: 'кг', hint: 'Полный блок (напр. 30 кг). До этого веса надбавки нет', step: 1 },
  { key: 'weightFirstExtra', label: 'Первые N кг', unit: 'ЅМ', hint: 'Надбавка с первого полного блока (напр. с 30 кг → +10)', step: 1 },
  { key: 'weightNextExtra', label: 'Каждые следующие N кг', unit: 'ЅМ', hint: 'Надбавка за каждый следующий полный блок (60, 90, 120…)', step: 1 },
