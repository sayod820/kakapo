...
export default function CashierModule({
  ...
  useEffect(() => {
    void import('@/lib/offlinePosOps').then(m => m.warmLocalSaleDisplayCounters()).catch(() => {})
  }, [])
  ...
  const activeShift = useMemo(() => {
    ...
    return raw ? overlayShiftSaleTotalsWithDebtRepay(raw, sales) : null
