...
export default function ProductTab({
  ...
  return (
    <div className="k-catalog-shell">
      <div className="k-catalog-head">
        ...
        <div className="k-cats k-cats-compact">
        ...
        {checked.size > 0 && (
          <div className="k-catalog-bulk" style={{ marginBottom: 0 }}>
