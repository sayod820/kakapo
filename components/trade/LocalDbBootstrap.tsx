...
export default function LocalDbBootstrap({
  ...
  return (
    <div className="ldb-wrap" data-theme={theme}>
      <style>{CSS}</style>
      <div className="ldb-card">
        <div className="ldb-badge">После доступа · один раз</div>
        <h1 className="ldb-title">Скачать все данные в SQLite</h1>
        <p className="ldb-sub">
          Доступ подтверждён. Сейчас один раз загрузим товары, склад, финансы, клиентов, карты и сотрудников
          на это устройство. Окно входа откроется <b>только после</b> полной загрузки.
          Потом касса шлёт на сервер только изменения.
        </p>
