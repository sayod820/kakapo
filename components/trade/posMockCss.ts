...
.pos-root button{font-family:inherit;cursor:pointer;border:none;background:none;color:inherit;}
  ...
  /* Касса: слева ровно 4 ряда плиток (4×150 + gaps + padding ≈ 680px), чек справа */
  .pos-root > .app{
    display:grid;
    grid-template-columns:minmax(660px,700px) minmax(280px,1fr);
  ...
  .pos-root button.shop-orders-chip{
    display:inline-flex;align-items:center;gap:6px;height:38px;padding:0 10px 0 8px;border-radius:12px;
    background:var(--surface2);border:1.5px solid var(--border);color:var(--t1);flex-shrink:0;font-weight:800;
    margin-left:auto;
  }
  .pos-root button.shop-orders-chip:hover,.pos-root button.shop-orders-chip.on{background:var(--border2);}
  .pos-root button.shop-orders-chip.hot{
    border-color:rgba(31,215,96,.35);background:rgba(31,215,96,.1);
  }
  .shop-orders-chip-ic{font-size:15px;line-height:1;}
  .shop-orders-chip-txt{font-size:12px;}
  .shop-orders-chip-n{
  ...
  .shop-orders-modal{
    width:min(520px,calc(100vw - 24px));max-height:min(78vh,720px);
    background:var(--surface);border:1.5px solid var(--border);border-radius:18px;
    box-shadow:0 22px 50px var(--shade);display:flex;flex-direction:column;overflow:hidden;
    animation:popIn .2s cubic-bezier(.16,1,.3,1);
  }
  .shop-orders-modal-head{
    display:flex;align-items:flex-start;justify-content:space-between;gap:10px;
    padding:14px 14px 12px;border-bottom:1px solid var(--border);
  }
  .shop-orders-modal-head b{display:block;font-size:14px;font-weight:900;}
  .shop-orders-modal-head span{display:block;font-size:11.5px;color:var(--t3);font-weight:650;margin-top:2px;}
  .shop-orders-list{padding:8px;overflow:auto;display:flex;flex-direction:column;gap:6px;min-height:0;}
  .pos-root button.shop-order-row{
    width:100%;text-align:left;padding:11px 12px;border-radius:13px;
    background:var(--surface2);border:1px solid var(--border);color:var(--t1);
    display:flex;flex-direction:column;gap:6px;
  }
  .pos-root button.shop-order-row:hover{border-color:var(--accent);}
  .pos-root button.shop-order-row.new{border-color:rgba(255,69,69,.28);background:rgba(255,69,69,.05);}
  .shop-order-row-main b{display:block;font-size:12.5px;font-weight:900;}
  .shop-order-row-main i{display:block;font-style:normal;font-size:11px;color:var(--t3);margin-top:2px;font-weight:650;}
  .shop-order-row-meta{display:flex;align-items:center;gap:8px;flex-wrap:wrap;font-size:11px;font-weight:750;color:var(--t2);}
  .shop-order-row-meta b{margin-left:auto;font-family:'JetBrains Mono',monospace;color:var(--t1);}
  ...
  .shop-order-detail-info > div{
    padding:8px 10px;border-radius:11px;background:var(--surface2);border:1px solid var(--border);
  }
  .shop-order-detail-info > div.full{grid-column:1 / -1;}
  .shop-order-detail-info span{display:block;font-size:10px;color:var(--t3);font-weight:700;}
  .shop-order-detail-info b{display:block;font-size:12px;font-weight:850;margin-top:2px;word-break:break-word;}
  .shop-order-items{display:flex;flex-direction:column;gap:5px;}
  .shop-order-item{
    display:grid;grid-template-columns:1fr auto auto;gap:8px;align-items:center;
    padding:8px 10px;border-radius:10px;background:var(--surface2);font-size:12px;font-weight:750;
  }
  .shop-order-item .nm{min-width:0;}
  .shop-order-item .qty,.shop-order-item .sum{color:var(--t3);font-family:'JetBrains Mono',monospace;font-size:11px;}
  .shop-order-item .sum{color:var(--t1);font-weight:850;}
  .shop-order-total{
    display:flex;justify-content:space-between;align-items:center;padding:10px 12px;
    border-radius:12px;background:rgba(31,215,96,.08);border:1px solid rgba(31,215,96,.2);
  }
  .shop-order-total span{font-size:12px;font-weight:800;color:var(--t2);}
  .shop-order-total b{font-size:16px;font-weight:900;font-family:'JetBrains Mono',monospace;}
  .shop-order-actions{display:flex;flex-wrap:wrap;gap:8px;}
  .shop-order-actions a.btn-switch-till{
  ...
  .cashier-screen-inner.receipts-fs .cashier-screen-top{margin-bottom:10px;flex-shrink:0;}
  ...
  .receipt-topbar{
    display:grid;grid-template-columns:minmax(220px,1fr) minmax(280px,1.05fr);
    gap:10px 14px;align-items:center;margin-bottom:10px;
  }
  ...
  .receipt-detail-scroll{
    flex:1;min-height:0;overflow:auto;-webkit-overflow-scrolling:touch;
    overscroll-behavior:contain;padding-bottom:8px;
  }
  .receipt-detail-meta{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;margin-bottom:12px;}
  .receipt-detail-meta > div{padding:8px 10px;border-radius:12px;background:var(--surface);border:1px solid var(--border);}
  .receipt-detail-meta span{display:block;font-size:9.5px;font-weight:800;color:var(--t3);text-transform:uppercase;letter-spacing:.04em;margin-bottom:3px;}
  .receipt-detail-meta b{font-size:12.5px;font-weight:800;line-height:1.25;}
  .receipt-detail-meta b.sum{font-family:'JetBrains Mono',monospace;font-size:16px;color:var(--accent);}
  .receipt-detail .hist-section-h{position:sticky;top:0;z-index:2;background:var(--bg);padding:6px 0;margin:0 0 6px;}
  ...
  .receipt-actions .action-chip{width:100%;justify-content:center;min-height:44px;}
  .receipt-actions .receipt-return-all{grid-column:1 / -1;}
  @media(max-width:900px){
    .receipt-detail-meta{grid-template-columns:1fr 1fr;}
  }
  @media(max-width:640px){
  ...
  .shift-reconcile-overlay{
    z-index:120;align-items:stretch;justify-content:center;
  ...
  .shift-reconcile-head{flex-shrink:0;}
  .shift-reconcile-card h3{margin:0 0 4px;font-family:'Unbounded',sans-serif;font-size:17px;}
  .shift-reconcile-sub{font-size:12px;color:var(--t2);font-weight:700;margin:0;line-height:1.35;}
  .shift-reconcile-inputs{
    display:grid;grid-template-columns:1fr 1fr;gap:10px;flex-shrink:0;
  }
  .shift-reconcile-block{margin:0;min-width:0;}
  ...
  .shift-rec-cols{display:flex;align-items:stretch;gap:8px;}
  .shift-rec-col{flex:1;min-width:0;}
  .shift-rec-col-h{font-size:10px;font-weight:800;color:var(--t2);text-transform:uppercase;letter-spacing:.03em;margin-bottom:6px;}
  .shift-rec-line{display:flex;justify-content:space-between;gap:6px;align-items:baseline;margin-bottom:4px;}
  .shift-rec-line span{font-size:12px;font-weight:800;color:var(--t2);}
  .shift-rec-line b{font-size:14px;font-weight:900;}
  .shift-rec-arrow{align-self:center;font-size:16px;font-weight:900;color:var(--t3);padding-top:14px;}
  .shift-rec-checks{display:grid;grid-template-columns:1fr 1fr;gap:6px;}
  .shift-rec-check{
    display:flex;flex-direction:column;gap:2px;
    padding:8px 10px;border-radius:11px;font-size:12px;min-width:0;
  }
  .shift-rec-check span{font-weight:800;color:var(--t2);}
  .shift-rec-check b{font-weight:900;line-height:1.25;}
  .shift-rec-check.ok{background:rgba(31,215,96,.12);}
  .shift-rec-check.ok b{color:var(--accent);}
  .shift-rec-check.warn{background:rgba(255,160,60,.14);}
  .shift-rec-check.warn b{color:var(--org);}
  .shift-rec-total{padding:10px 12px;border-radius:11px;display:flex;flex-direction:column;gap:2px;}
  .shift-rec-total b{font-size:13px;font-weight:900;line-height:1.3;}
  .shift-rec-total small{font-size:11px;font-weight:700;opacity:.85;line-height:1.3;}
  .shift-rec-total.ok{background:rgba(31,215,96,.14);color:var(--accent);}
  .shift-rec-total.warn{background:rgba(255,160,60,.16);color:var(--org);}
  ...
  .p-grid-spacer{width:100%;}
  /* Виртуальная сетка: без анимации появления на каждый ряд (иначе лаг при скролле) */
  .p-grid-virtual .pos-root button.p-tile,
  .pos-root .p-grid-virtual button.p-tile{animation:none;}
  .p-grid-virtual .p-photo img{animation:none;}
  .p-photo{width:100%;height:96px;border-radius:12px;background:linear-gradient(145deg,var(--surface2),var(--surface3));display:flex;align-items:center;justify-content:center;font-size:40px;margin-bottom:10px;position:relative;overflow:hidden;contain:layout paint;}
  /* Без бесконечной анимации фото — на 3000 товарах это сильно грузит слабый ПК */
  .p-photo img{width:100%;height:100%;object-fit:contain;object-position:center;padding:5px;box-sizing:border-box;display:block;}
  .p-grid-virtual .p-photo img,
  ...
  .hist-card-fs .hist-scroll.profile{max-height:none;}
  ...
  .cart-items{flex:1;min-height:0;overflow-y:auto;padding:10px 14px;position:relative;scroll-behavior:auto;overscroll-behavior:contain;}
  .cart-empty{text-align:center;color:var(--t3);padding:36px 10px;}
  .cart-empty .ic{font-size:34px;opacity:.5;margin-bottom:8px;}
  .cart-row{display:flex;align-items:center;gap:10px;padding:11px 8px;border-radius:14px;border:1px solid transparent;cursor:pointer;}
  .cart-row.is-new{animation:rowIn .22s ease both;background:rgba(31,215,96,.18);border-color:rgba(31,215,96,.55);}
  .cart-row:hover{background:var(--surface2);border-color:var(--border);}
  .cart-row.sel{background:rgba(31,215,96,.12);border-color:rgba(31,215,96,.45);box-shadow:inset 3px 0 0 var(--green);}
  .cart-row .ic{width:44px;height:44px;border-radius:12px;background:var(--surface2);display:flex;align-items:center;justify-content:center;font-size:20px;flex-shrink:0;padding:0;overflow:hidden;border:1px solid var(--border);}
  .cart-row .info{flex:1;min-width:0;}
  .cart-row .name-row{display:flex;align-items:center;gap:8px;min-width:0;}
  .cart-row .name{font-size:13.5px;font-weight:800;line-height:1.3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;min-width:0;flex:1;}
  .cart-row .unit-badge{
    flex-shrink:0;
    padding:3px 9px;
    border-radius:999px;
    background:rgba(31,215,96,.14);
    border:1px solid rgba(31,215,96,.32);
  ...
  .pos-root[data-theme="light"] .cart-row .unit-badge{
    background:rgba(11,122,56,.1);
    border-color:rgba(11,122,56,.28);
    color:#0B7A38;
  }
  ...
  .pos-root button.qty-btn{flex-shrink:0;min-width:48px;min-height:38px;padding:8px 12px;border-radius:11px;background:var(--surface2);border:1.5px solid var(--border);font-family:'JetBrains Mono',monospace;font-size:15px;font-weight:900;color:var(--t1);display:inline-flex;align-items:center;justify-content:center;line-height:1;}
  ...
  .qty-edit-av{width:48px;height:48px;border-radius:14px;background:var(--surface2);border:1px solid var(--border);display:flex;align-items:center;justify-content:center;font-size:26px;flex-shrink:0;padding:0;overflow:hidden;}
  ...
  .disc-product-line{
    display:flex;flex-direction:column;gap:2px;margin:-4px 0 12px;
  }
  ...
  .hist-fs-head{display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:12px;}
  .hist-fs-x{
    width:40px;height:40px;border-radius:12px;border:1.5px solid var(--border);
    background:var(--surface2);color:var(--t2);font-size:18px;font-weight:800;cursor:pointer;flex-shrink:0;
  }
  .hist-fs-x:hover{border-color:rgba(220,80,60,.45);color:#c23b2a;}
  .hist-detail-head .hist-fs-x{margin-left:auto;}
  .client-kpis-fs{grid-template-columns:1.45fr 1fr 1fr 1fr;gap:10px;}
  .client-kpi.big .v{font-size:28px;}
  .client-kpi .hint{font-size:11px;color:var(--t3);margin-top:4px;line-height:1.3;}
  .client-kpi.warn{border-color:rgba(255,140,0,.35);background:rgba(255,140,0,.06);}
  ...
  .cashier-debts-hero{
    display:grid;grid-template-columns:1.4fr 1fr;gap:10px;margin:12px 0 8px;flex-shrink:0;
  }
  .cashier-debts-hero-main{
    padding:12px 14px;border-radius:14px;background:rgba(255,90,90,.08);
    border:1px solid rgba(255,90,90,.28);
  }
  .cashier-debts-hero-main .kl{font-size:12px;color:var(--t3);font-weight:800;}
  .cashier-debts-hero-main .kv{font-size:28px;font-weight:900;margin-top:4px;line-height:1.1;font-family:'JetBrains Mono',monospace;}
  .cashier-debts-hero-cur{font-size:14px;font-weight:800;margin-left:4px;opacity:.85;}
  .cashier-debts-hero-main .kh{font-size:11px;color:var(--t3);margin-top:6px;line-height:1.35;}
  .cashier-debts-hero-side{
    display:flex;flex-direction:column;gap:6px;padding:10px 12px;border-radius:14px;
    background:var(--surface2);border:1px solid var(--border);
  }
  .cashier-debts-hero-side > div{display:flex;justify-content:space-between;align-items:baseline;gap:8px;}
  .cashier-debts-hero-side .kl{font-size:11px;color:var(--t3);font-weight:700;}
  .cashier-debts-hero-side b{font-size:14px;font-family:'JetBrains Mono',monospace;}
  .cashier-debts-split{
  ...
  @media (max-width:900px){
    ...
    .cashier-debts-hero{grid-template-columns:1fr;}
    .cashier-debts-hero-main .kv{font-size:24px;}
    ...
    .cashier-debts-table td:nth-child(2){grid-column:1/-1;font-size:13px;font-weight:700;white-space:normal;}
    .cashier-debts-table td:nth-child(3){grid-column:1;font-size:14px;font-weight:900;}
    .cashier-debts-table td:nth-child(4){grid-column:2;justify-self:end;font-size:13px;}
    .cashier-debts-table td:nth-child(4)::before{content:'долг ';font-weight:700;color:var(--t3);font-size:10px;}
  }
  ...
  .overlay.hist-detail-overlay{
    z-index:340;align-items:center;justify-content:center;padding:12px;
    overscroll-behavior:contain;
  }
  .modal-card.hist-detail-card{
    width:min(440px,100%);max-width:calc(100vw - 24px);
    max-height:min(92vh,860px);height:auto;
    display:flex;flex-direction:column;padding:16px 16px 12px;
    overflow:hidden;
  }
  .hist-detail-head{display:flex;align-items:center;gap:10px;margin-bottom:10px;flex-shrink:0;}
  .hist-detail-head h3{margin:0;}
  .hist-detail-body{
    flex:1;min-height:0;overflow-y:auto;overflow-x:hidden;
    -webkit-overflow-scrolling:touch;overscroll-behavior:contain;
    padding-right:2px;margin:0 -2px;padding-left:2px;
  }
  .hist-detail-foot{
    flex-shrink:0;display:flex;flex-direction:column;gap:8px;
    padding-top:12px;margin-top:8px;border-top:1px solid var(--border);
  }
  .hist-detail-foot .btn-confirm{width:100%;justify-content:center;}
  .hist-detail-nums{
    display:grid!important;grid-template-columns:repeat(3,1fr)!important;gap:8px!important;
    justify-content:stretch!important;border-top:none!important;margin-top:0!important;padding-top:0!important;
  }
  .hist-detail-nums > div,.hist-detail-nums > span{
  ...
  .hist-lines{display:flex;flex-direction:column;gap:8px;padding-bottom:4px;}
  ...
  @media (max-width:900px){
    .overlay.hist-detail-overlay{padding:0;align-items:stretch;}
    .modal-card.hist-detail-card{
  ...
  .client-result .av{width:34px;height:34px;border-radius:11px;background:linear-gradient(135deg,var(--accent2),var(--accent));display:flex;align-items:center;justify-content:center;font-family:'Unbounded';font-weight:800;font-size:12px;color:var(--bg);flex-shrink:0;padding:0;overflow:hidden;}
  ...
  .modal-card.barcode-pick-card{
    width:min(400px,94vw);max-height:min(72vh,520px);
    display:flex;flex-direction:column;padding:14px 14px 12px;gap:0;
  }
  .barcode-pick-head{
    display:flex;align-items:flex-start;justify-content:space-between;gap:8px;margin-bottom:10px;
  }
  .barcode-pick-head-text{min-width:0;flex:1;}
  .barcode-pick-head h3{margin:0 0 2px;font-size:16px;line-height:1.25;}
  .barcode-pick-head p{
    margin:0;font-size:12px;color:var(--t2);line-height:1.35;
    white-space:nowrap;overflow:hidden;text-overflow:ellipsis;
  }
  .barcode-pick-head code{
    font-family:ui-monospace,Consolas,monospace;font-size:11px;font-weight:700;color:var(--t1);
  }
  .barcode-pick-list{
    display:flex;flex-direction:column;gap:6px;overflow:auto;
    max-height:min(42vh,340px);padding-right:2px;margin:0;
  }
  .barcode-pick-row{
    display:grid;grid-template-columns:44px minmax(0,1fr) auto;align-items:center;gap:10px;
    text-align:left;padding:8px 10px;border-radius:10px;border:1px solid rgba(40,90,50,.2);
  ...
  .barcode-pick-body{min-width:0;display:flex;flex-direction:column;gap:2px;}
  .barcode-pick-name{
    font-size:13px;font-weight:700;line-height:1.25;
    display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;
  }
  .barcode-pick-meta{font-size:11px;color:var(--t3);line-height:1.3;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
  .barcode-pick-price{
    font-size:14px;font-weight:800;font-variant-numeric:tabular-nums;color:var(--t1);
    white-space:nowrap;padding-left:4px;
  }
  .barcode-pick-actions{margin-top:10px;}
  ...
  @media(max-width:1400px){
    .pos-root > .app{grid-template-columns:minmax(520px,560px) minmax(260px,1fr);}
  }
  @media(max-width:1200px){
    .pos-root > .app{grid-template-columns:minmax(360px,400px) minmax(240px,1fr);}
  ...
  @media(max-width:900px){
    ...
    .pos-root button.shop-orders-chip{order:2;height:34px;padding:0 8px;border-radius:10px;gap:4px;}
    .shop-orders-chip-txt{display:none;}
    ...
    .app[data-mob-panel="shop"] .products,
    .app[data-mob-panel="cart"] .cart{
      display:flex!important;flex-direction:column;min-height:0;height:100%;max-height:none;overflow:hidden;
    }
    .products,.cart{border:none;min-height:0;}
    .cart{border-top:none;}
    .grid-wrap{padding:8px 10px 12px;-webkit-overflow-scrolling:touch;}
    .p-grid{grid-template-columns:repeat(auto-fill,minmax(132px,1fr));gap:10px;}
    .pos-root button.p-tile{padding:10px;border-radius:14px;min-height:44px;}
    .p-photo{height:84px;margin-bottom:8px;}
    .p-name{font-size:12px;min-height:28px;}
    .p-price{font-size:16px;}
    .pos-root button.cat-pill{padding:10px 14px;min-height:44px;font-size:13px;}
  ...
  @media(max-width:600px){
    ...
    .modal-card{
      ...
      border-radius:0;margin:0;height:auto;min-height:min(100dvh,100%);
    }
    .wide-card{width:100%!important;max-height:100dvh;}
  }
`
