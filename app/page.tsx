...
const APPS = [
  ...
  { href:'/trade',     icon:'🏪', title:'Торговля',           desc:'Касса, склад, товары и финансы', sub:'Касса · Товары · Склад · Долги · Отчёты', color:'#14D4B4', bg:'linear-gradient(135deg,#041816,#0B2D29)', border:'rgba(20,212,180,.3)' },
